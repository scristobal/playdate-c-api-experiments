...
local function makeTriShape(f, st, sp, t, c)
	return makeShape(f, st, sp, t, c, false)
end
local function makeQuadShape(f, st, sp, t, c)
	return makeShape(f, st, sp, t, c, true)
end
...
local s1 = makeTriShape(knot, 48, 16, 0.3, function(i, j, s)
	return 0.5 - (i % 2)
end)
