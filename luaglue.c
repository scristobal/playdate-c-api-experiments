...
static const lua_reg lib3DScene[] = {{"__gc", scene_gc},
                                     {"new", scene_new},
                                     {"draw", scene_draw},
...
static const lua_reg lib3DNode[] = {{"__gc", node_gc},
...
static const lua_reg lib3DShape[] = {{"new", shape_new},
                                     {"__gc", shape_gc},
...
static const lua_reg lib3DPoint[] = {{"new", point_new},       {"__gc", point_gc},
                                     {"__index", point_index}, {"__newindex", point_newindex},
                                     {"__mul", point_mul},     {NULL, NULL}};
...
static const lua_reg lib3DMatrix[] = {{"__gc", matrix_gc},
                                      {"__mul", matrix_mul},
                                      {"new", matrix_new},
